...
from .views import (home, about, contact, register_view, login_view, profile, logout_view, create_blog, blog_list, blog_detail,edit_blog, delete_blog, category_blogs)
